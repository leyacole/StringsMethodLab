...
public class StringLab {
	...
	public static void main(String[] args) {
		...
		System.out.println(capitalize("lEYA"));
		System.out.println(wheresWaldo("Waldo who"));
		System.out.println(firstThingsFirst("zebra", "boy"));
		System.out.println(reverse("Coleman"));
		soLong("message", "Coleman");
		//afterMath("The boring mathmetics class is tomorrow");
		letterSize("Coleman");
